...
define(
  ...
  function(
    ...
    var ReadableMemoryStream;
    ReadableMemoryStream = axiom$fs$stream$readable_memory_stream$$["default"];
    var WritableMemoryStream;
    WritableMemoryStream = axiom$fs$stream$writable_memory_stream$$["default"];
...
define(
 ...
 function(
  ...
  var ReadableMemoryStream = function(buffer) {
  ...
  __es6_export__("ReadableMemoryStream", ReadableMemoryStream);
  __es6_export__("default", ReadableMemoryStream);
...
define(
 ...
 function(axiom$core$error$$, axiom$fs$stream$axiom_stream$$, __exports__) {
  "use strict";
  ...
  var WritableMemoryStream = function(buffer) {
    AxiomStream.call(this);
    /** @const @private @type {MemoryStreamBuffer} */
    this.buffer_ = buffer;
  };

  __es6_export__("WritableMemoryStream", WritableMemoryStream);
  __es6_export__("default", WritableMemoryStream);
